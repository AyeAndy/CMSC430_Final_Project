...
void testround()
{
    ...
    const hamt<tuple, tuple>* h = new ((hamt<tuple,tuple>*)malloc(sizeof(hamt<tuple,tuple>))) hamt<tuple,tuple>();
    ...
    {
        const tuple* const t = new ((tuple*)malloc(sizeof(tuple))) tuple(i,i+1,i*i);
        h = h->insert(t,t);

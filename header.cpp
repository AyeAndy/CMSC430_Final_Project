...
#define ENCODE_HASH(v) (((u64)(v)) | OTHER_TAG)

#define DECODE_SET(v) ((u64*)((v)&(7ULL^MASK64)))
#define ENCODE_SET(v) (((u64)(v)) | OTHER_TAG)
...
{
    current_memory = current_memory+512*sizeof(u64);
...
u64 prim_make_45vector(u64 lenv, u64 iv)
{
    ...
    //printf("make-vector-length: %llu", l);
    //printf("\n");

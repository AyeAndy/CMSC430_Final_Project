...
(define prims-list '(= > < <= >= + - * / 
                     ...
                     hash hash-ref hash-set hash-count hash-keys hash-remove hash-has-key? hash?
                     set set-add set-remove set-member?
...
(define (eval-llvm llvm-str)
  ...
  (define header-str (read-string 1000000 (open-input-file "header.ll" #:mode 'text)))
